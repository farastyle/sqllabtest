...
const testesXss = [
    ...
    { id: 'xss4', nome: '4️⃣ Defacement da Página', payload: `<script>document.body.innerHTML = '<h1 style=\"color:red;text-align:center;margin-top:100px;\">Esta página foi totalmente substituída por um script - isso não deveria ser possível</h1>'</script>`, onde: 'Mural', descricao: 'Mostra o pior cenário: o conteúdo inteiro da página é apagado e troncado por outra coisa, sem o usuário perceber a troca' },
